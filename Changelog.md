...
- Fix UI issues especially with hidden checkbox texts on some machines by adding UI Fallback setting [Settings » Usewr Interface » UI Fallback] ([#978](/../../issues/978))
