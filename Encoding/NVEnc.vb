            ...
            Get
                If ItemsValue Is Nothing Then
                    ...
                    Add("Basic", Mode, Decoder, Codec,
                        New OptionParam With {.Switch = "--preset", .HelpSwitch = "-u", .Text = "Preset", .DefaultValue = 6, .Init = 6, .Options = {"Default", "Quality", "Performance", "P1 (=Performance)", "P2", "P3", "P4 (=Default)", "P5", "P6", "P7 (=Quality)"}, .Values = {"default", "quality", "performance", "P1", "P2", "P3", "P4", "P5", "P6", "P7"}},
                        Profile, ProfileH265,
