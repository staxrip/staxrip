        ...
        Get
            If ItemsValue Is Nothing Then
                ...
                Add("Analysis", RD,
                    ...
                    New OptionParam With {.Switch = "--rskip", .Text = "Recursion Skip", .Expand = True, .Options = {"Undefined", "0 - RD Level 0-4 Neighbour costs", "1 - RD Level 5-6 Comparison with inter2Nx2N", "2 - RD Level 0-6 CU edge denstiy", "3 - RD Level 0-6 CU edge denstiy with forceful skip for lower levels of CTU"}, .Values = {"", "0", "1", "2", "3"}},
                ...
                Add("VUI",
                    ...
                    New BoolParam With {.Switch = "--hdr-opt", .NoSwitch = "--no-hdr-opt", .Text = "Add luma and chroma offsets for HDR/WCG content"},
