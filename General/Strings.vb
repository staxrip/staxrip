Friend Class Strings
    ...
    Public Shared MacrosHelp As String = "Macros are placeholders that can be used in command lines and other places, on execution StaxRip replaces the macros with the actual values."
    ...
    Public Shared NoUnicode As String = $"Unicode filenames are not supported by AviSynth.{BR2}VapourSynth supports unicode.{BR2}Filters > Filters Setup > VaourSynth"
