...
Public Class Strings
    Public Shared CharacterLimitReason As String = "In theory, Windows supports paths that are longer than 260 characters, but in reality, neither Windows, the .NET Framework, nor the used tools have full long path support."
