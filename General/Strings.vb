...
Public Class Strings
    Public Shared CharacterLimitReason As String = "In theory Windows supports paths that are longer than 260 characters, in reality neither Windows, nor the .NET Framework or the used tools have full long path support. StaxRip has a setting that allows to increase the limit but it's not recommended to change this limit! It will almost certainly not work!"
