Friend Class Strings
    ...
    ''Public Shared ProjectX As String = "ProjectX demuxes MPEG-2 DVD and DVB sources, H.264/AVC and H.265/HEVC are not supported. ProjectX can be enabled or disabled in the settings on the preprocessing tab tab."
