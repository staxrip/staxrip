Public Class Strings
    ...
    Public Const ProjectX As String = "ProjectX demuxes and fixes MPEG-2 TS, H264/AVC and H265/HEVC are not supported. ProjectX can be enabled or disabled in the settings on the Demuxing tab. Java x86 is recommended, Java x64 works probably too."
