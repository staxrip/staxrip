...
Public Class FilterCategory
    ...
    Shared Function GetAviSynthDefaults() As List(Of FilterCategory)
        ...
        color.Filters.Add(New VideoFilter(color.Name, "HDRCore | BitdepthLsb", "LSB = BitdepthLsb(bitdepth=$select:msg:Select BitDepth;16;32;88$)"))
        color.Filters.Add(New VideoFilter(color.Name, "HDRCore | BitdepthMsb", "MSB = BitdepthMsb(bitdepth=$select:msg:Select BitDepth;16;32;88$)"))
        color.Filters.Add(New VideoFilter(color.Name, "HDRCore | BitdepthMsbLsb", "BitdepthMsbLsb(MSB, LSB, bitdepth=$select:msg:Select BitDepth;8;16;32;88$)"))
        color.Filters.Add(New VideoFilter(color.Name, "HDRCore | Clamp HDR", "ClampHDR($select:msg:Select the Range you Wish to Use;TV Range|ay=16,by=235,au=16,bu=240,av=16,bv=240;PC Range|ay=0,by=255,au=0,bu=255,av=0,bv=255$, bitdepth=$select:msg:Select BitDepth;8;16;32;88$)"))
        ...
        color.Filters.Add(New VideoFilter(color.Name, "HDRToneMapping", "$select:msg:Select the Map Tone You Wish to Use;DGReinhard|DGReinhard();DGHable|DGHable()$"))
        ret.Add(color)
