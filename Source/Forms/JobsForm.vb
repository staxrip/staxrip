...
#End Region
    ...
    Sub New(theme As Theme)
        ...
        cms.Add("-")
        cms.Add("Move Selection To Top", Sub() lv.MoveSelectionTop(), Keys.Home, Function() lv.CanMoveUp)
        cms.Add("Move Selection To Bottom", Sub() lv.MoveSelectionBottom(), Keys.End, Function() lv.CanMoveDown)
        cms.Add("-")
