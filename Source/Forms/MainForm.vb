...
b.Help = "Binary: 1 MiB = 1024 KiB" + BR + "Decimal: 1 MB = 1000 KB" + BR + BR + "When selected, Staxrip will use binary prefix instead of decimal in the display and caclulation of sizes." + "This will not affect encoders information display which is usually decimal."
