...
b.Help = "Binary: 1 MiB = 1024 KiB" + BR + "Decimal: 1 MB = 1000 KB" + BR + BR + "When selected, StaxRip will use binary prefix (MiB) instead of decimal prefix (MB)." + BR + "This will not affect information displayed by encoders, which is usually decimal."
