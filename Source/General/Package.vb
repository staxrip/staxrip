...
Public Class Package
    ...
    Shared Property Zs_RF_Shared As Package = Add(New PluginPackage With {
        ...
        .AvsFilterNames = {"sh_StrReplace", "sAverageLumaMask", "m4_sh", "sh_sharpen2", "sh_SootheSS", "slinesm", "t_linemask", "swlinesm", "GreyCenteredToMask_dhh", "Camembert_dhh", "Camembert_dhhMod", "EMask_dhh", "spasses", "spasses2", "sminideen", "DarkPreserve_function", "lightPreserve_function", "sh_Padding", "sTryFTurnRight", "sTryFTurnLeft", "sTryFTurn180", "slimit_dif", "slimit_dif2", "sh_GetCSP", "sh_Y8_YV411", "ContraSharpeningHD", "MinBlur", "sbr", "Dither_YUY2toPlanar16", "Dither_YUY2toPlanar", "Dither_YUY2toInterleaved16", "Dither_YUY2toInterleaved", "Dither_Luma_Rebuild", "SH_KNLMeansCL", "sh_RemoveGrain", "y_gamma_to_linear", "y_linear_to_gamma", "linear_and_gamma", "build_sigmoid_expr", "sigmoid_direct", "sigmoid_inverse", "sh_Vinverse2", "sbrV", "sh_Vinverse2H", "sbrH", "sBlackerPixel", "swhiterPixel", "chroma_rep", "chroma_rep2", "smartfademod", "ediaa", "daa", "maa", "SharpAAMCmod", "VinverseD", "smam", "smam_mask", "Hqdn3d_2", "interlaced60or50", "convert_Fields_scan_order", "yadifmodclipin", "yadifmodclipout", "tmm2_ortmm1", "nonyuy2clipin", "nonyuy2clipout", "sh_LimitChange", "sh_Bob", "sneo_FFT3D", "sneo_dfttest", "svsTTempSmooth", "svsTTempSmoothf", "svsMSharpen", "svsTBilateral", "svsTcanny", "sTcannyMod", "sh_GetUserGlobalIMT", "sh_GetUserGlobalIMTint", "sh_GetUserGlobalIMTbool", "sChromaShift2", "ChrEatWhite", "IsAvsNeo", "IsAvsPlus", "AvsPlusVersionNumber"}})
