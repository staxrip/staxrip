...
- `.NET Framework 4.8 x64 <https://www.microsoft.com/net/download/dotnet-framework-runtime>`_
- `Visual C++ 2019 Redist x64 (minimum 14.24.28127.4) <https://support.microsoft.com/en-gb/help/2977003/the-latest-supported-visual-c-downloads>`_
